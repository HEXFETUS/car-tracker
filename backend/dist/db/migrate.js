...
async function main() {
    ...
    `);
        ...
        const { rows: appliedRows } = await pool.query(`SELECT filename FROM "${TRACKING_TABLE}" ORDER BY filename`);
        ...
        for (const file of files) {
            ...
            try {
                ...
                await client.query(`INSERT INTO "${TRACKING_TABLE}" (filename, md5) VALUES ($1, $2)`, [file, md5]);
