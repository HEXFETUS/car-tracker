...
export const CRON_BATCH_SIZE = Math.max(1, Math.floor(num('CRON_BATCH_SIZE', 10)));
export const CRON_SOFT_DEADLINE_MS = Math.max(1000, Math.floor(num('CRON_SOFT_DEADLINE_MS', 240000)));
