...
export const FLEET_CONFIG = {
  ...
  trip: {
    ...
    /** Distance improvement toward origin required before motion is classified as RETURN */
    returnDirectionMarginMeters: 100,
  },
} as const;

/** Type helper for the fleet config shape. */
export type FleetConfig = typeof FLEET_CONFIG;
