...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left — Branding */}
      <div className="hidden w-1/2 flex-col items-center justify-center bg-brand-teal p-12 text-white lg:flex">
        <div className="max-w-md text-center">
          <div className="mx-auto mb-6 flex size-16 items-center justify-center rounded-2xl bg-white/10">
            <Car className="size-8 text-brand-cream" />
          </div>
      ...
      <div className="flex w-full items-center justify-center bg-white p-8 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-6 text-center text-xs text-zinc-400">
            Demo: use any password — user{' '}
            <span className="font-mono text-zinc-600">alex.driver@fleet.com</span>
          </p>
        </div>
      </div>
    </div>
